...
## Consequences
- **Pros**: CSS styling is fully isolated (no bleed in either direction). The widget can easily be embedded on any approved client website (including CMSs like TYPO3) by pasting a single script tag.
